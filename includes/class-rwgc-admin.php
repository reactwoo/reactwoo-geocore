			...
			wp_localize_script(
				...
				array(
					...
					'i18n'              => array(
						...
						'couldNotCreateRule'   => __( 'Could not create rule', 'reactwoo-geocore' ),
						'executeStillNeeds'    => __( 'This still needs:', 'reactwoo-geocore' ),
						'stateMismatchWarning' => __( 'State mismatch: visible action is ready but execute payload still has unresolved fields.', 'reactwoo-geocore' ),
						'stateMismatchTitle'   => __( 'State mismatch', 'reactwoo-geocore' ),
						...
						'ruleLinkVerifyFailed' => __( 'The server returned a rule link, but the rule could not be opened or verified.', 'reactwoo-geocore' ),
						'ruleVerifyDetailsLabel' => __( 'Details:', 'reactwoo-geocore' ),
						'ruleVerifyReturnedPostId' => __( 'Returned post ID', 'reactwoo-geocore' ),
						'ruleVerifyReturnedUrl' => __( 'Returned URL', 'reactwoo-geocore' ),
						'ruleVerifyNotEditable' => __( 'Status: not editable / wrong object', 'reactwoo-geocore' ),
						'retryCreateRule'      => __( 'Retry create', 'reactwoo-geocore' ),
