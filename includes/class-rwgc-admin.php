			...
			wp_localize_script(
				...
				array(
					...
					'i18n'              => array(
						...
						'googleAdsWhy'          => __( 'Geo Core needs to know how to recognise visits from Google Ads.', 'reactwoo-geocore' ),
						...
						'googleAdsOptCustom'    => __( 'Configure custom mapping', 'reactwoo-geocore' ),
						'googleAdsOptCustomDesc' => __( 'Open mapping settings', 'reactwoo-geocore' ),
						'googleAdsShortCustom'  => __( 'Custom mapping', 'reactwoo-geocore' ),
						'googleAdsCustomMappingLabel' => __( 'Custom mapping label', 'reactwoo-geocore' ),
						'googleAdsCustomMappingPlaceholder' => __( 'Describe how to recognise this traffic', 'reactwoo-geocore' ),
