	...
	public function register_targets( RWGC_Target_Registry $registry ) {
		...
		$registry->register_target_type(
			array(
				...
				'group'         => 'analytics',
				'description'   => __( 'True when a previous visit left a Geo Core cookie. First visit is not returning.', 'reactwoo-geocore' ),
				'operators'     => array( 'is', 'is_not' ),
				'value_mode'    => 'boolean',
				'provider'      => $this->get_provider_key(),
				'supports_simulation' => true,
		...
		$registry->register_target_type(
			array(
				...
				'group'         => 'analytics',
				'description'   => __( 'Inverse of returning visitor. First visit, or cookies cleared.', 'reactwoo-geocore' ),
				'operators'     => array( 'is', 'is_not' ),
				'value_mode'    => 'boolean',
				'provider'      => $this->get_provider_key(),
				'supports_simulation' => true,
