...
class RWGC_Admin_Section_Hubs {
	...
	private static function default_card_description( $slug, array $route ) {
		$map = array(
			...
			'rwgcm-merchandising'     => __( 'Geo-based product messaging and merchandising outcomes.', 'reactwoo-geocore' ),
			'rwgcm-availability'      => __( 'Geo-based product visibility and purchase eligibility.', 'reactwoo-geocore' ),
