...
class RWGC_Elementor_Popups {
	...
	public static function print_popup_show_patch_script() {
		...
		wp_print_inline_script_tag(
			...
			. 'if(typeof elementorFrontend!=="undefined"){var docRoot=elementorFrontend.documents&&elementorFrontend.documents.manager&&elementorFrontend.documents.manager.documents&&elementorFrontend.documents.manager.documents[0];'
