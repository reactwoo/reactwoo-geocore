...
Status: Sprint 5 implemented in Decision Cloud `0.13.0` (upgrade eligibility + ReactWoo.com handoff, Figma 23–25). Sprint 3 activation remains in `0.12.0`. Sprint 2 remains in `reactwoo-api-manager` (`includes/cloud-commerce/`). Sprint 1 commerce boundary remains in Cloud `0.11.0`.  
...
| 4 Guided site connection | Decision Cloud | Next (Figma 26–31) |
...
- Site pairing UI (Figma 26–31) is Sprint 4; the complete CTA only navigates to `#/sites`
