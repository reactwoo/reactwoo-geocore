...
| Document | Role |
|----------|------|
| [PLAN.md](./PLAN.md) | **Canonical commercial & subscription model** — Cloud is the upgrade bundle; covered individual plugins are superseded, not double-billed |
...
| [commerce-and-onboarding.md](./commerce-and-onboarding.md) | Cloud commerce, upgrade and onboarding sequence (sprints 1–6); bundle replacement is [PLAN.md](./PLAN.md) |
...
| [../performance/decision-runtime.md](../performance/decision-runtime.md) | WP19 Decision Runtime performance (candidate audiences, lazy context) |
